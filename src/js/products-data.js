...
const pushMap = document.querySelector(".card__products");

function cardOur(products) {
  let mode = "";
  ...
  products.forEach((pro) => {
    ...
    <div class="card__header">
      <img src="${pro.images[0]}" alt="product_cards" />
      <div class="likes">
        <img src="../img/icons/heart.svg" alt="product_cards" />
      </div>
    </div>
    <div class="card__body">
      <div class="card__body-content">
        <div class="content-left">
          <h3 class="content__price">${pro.price}0₽</h3>
          <span class="content__text">С картой</span>
        </div>
      </div>
      <p class="card__body-p">${pro.description}</p>
      <div class="starts">
        <img src="../img/icons/start.svg" alt="starts" />
        <img src="../img/icons/start.svg" alt="starts" />
        <img src="../img/icons/start.svg" alt="starts" />
        <img src="../img/icons/start.svg" alt="starts" />
        <img src="../img/icons/start.svg" alt="starts" />
